 ...
 * @author admin
 */
public class QLCaLam extends javax.swing.JDialog {

    /**
     * Creates new form QLCaLam
     */
    public QLCaLam(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jTable2.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "STT", "MÃ NV", "TÊN NV", "NGÀY LÀM", "CA LÀM"
            }
        ));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(QLCaLam.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                QLCaLam dialog = new QLCaLam(new javax.swing.JFrame(), true);
